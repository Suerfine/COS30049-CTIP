...
export async function runSeeders(
  ...
  const sensors = [
    {
      id: 1,
      name: "Fire & Smoke Detector - Talang Satang Zone A",
      type: "gas_temp",
      longitude: 110.16339680898895,
      latitude: 1.7842945364128349,
      location: "Talang Satang National Park - Zone A",
      current_status: SensorStatus.ALERTING,
    },
    {
      id: 2,
      name: "Motion Radar - Santubong Zone B",
      type: "motion",
      longitude: 110.31410363493956,
      latitude: 1.7466374623217293,
      location: "Santubong National Park - Zone B",
      current_status: SensorStatus.NORMAL,
    },
    {
      id: 3,
      name: "Acoustic Monitor - Bako Zone C",
      type: "acoustic",
      longitude: 110.4312044102889,
      latitude: 1.6627030756386916,
      location: "Bako National Park - Zone C",
      current_status: SensorStatus.NORMAL,
    },
    {
      id: 4,
      name: "Ultrasonic Level Sensor - Semenggoh Zone A",
      type: "ultrasonic",
      longitude: 110.31370907818214,
      latitude: 1.4020006518594441,
      location: "Semenggoh Nature Reserve - Zone A",
      current_status: SensorStatus.NORMAL,
    },
    {
      id: 5,
      name: "Smoking Detector - Kuching Wetland Zone B",
      type: "gas_temp",
      longitude: 110.2518273733255,
      latitude: 1.6894278317016738,
      location: "Kuching Wetland National Park - Zone B",
      current_status: SensorStatus.NORMAL,
    },
  ];
