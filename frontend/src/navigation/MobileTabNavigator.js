/**
 * @deprecated This component is now integrated into ParkGuideNavigator.
 * Use ParkGuideNavigator instead for the complete navigation stack.
 */
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Tab.Screen name="Badge" component={Award} />
        <Tab.Screen
          name="UserProfile"
