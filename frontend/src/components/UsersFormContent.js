...
import { View, Text, TextInput, StyleSheet, Pressable, Image, ActivityIndicator, TouchableOpacity, useWindowDimensions } from 'react-native';
...
const UsersFormContent = ({ onSubmit, onCancel, isLoading }) => {
    ...
    const [form, setForm] = useState({
        ic: '', email: '', image: null, fname: '', lname: '', telefon: '', role: 'parkguide'
    });
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.header, localStyles.rowHeader]}>
                ...
                <Pressable onPress={onCancel}><X /></Pressable>
            </View>

            <View style={[localStyles.formContainer, isCompact && localStyles.formStack]}>
                {/* Inputs Container - Appears on Left (Desktop) or Top (Mobile) */}
                <View style={[localStyles.fieldsColumn, isCompact && localStyles.fullWidth]}>
                    ...
                    <View style={localStyles.singleFieldGroup}>
                        ...
                        <View style={localStyles.radioGroupRow}>
                            <TouchableOpacity style={localStyles.radioOption} onPress={() => setForm({ ...form, role: 'admin' })}>
                                <View style={localStyles.radioCircle}>{form.role === 'admin' && <View style={localStyles.selectedRb} />}</View>
                                <Text style={localStyles.radioText}>Admin</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={localStyles.radioOption} onPress={() => setForm({ ...form, role: 'parkguide' })}>
                                <View style={localStyles.radioCircle}>{form.role === 'parkguide' && <View style={localStyles.selectedRb} />}</View>
                ...
                <View style={[styles.upload, localStyles.uploadSection, isCompact && localStyles.fullWidth]}>
