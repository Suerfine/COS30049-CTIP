...
const OutlineBar = ({
  ...
  return (
    <View
      style={[
        styles.outlinebar,
        dropdown && styles.dropdownOutline,
    ...
    >
      ...
      {!isCollapsed && (
        <Pressable
          style={[
            styles.item,
            selectedItem?.type === "overview" && styles.selected,
          ]}
      ...
      <FlatList
          ...
          <>
            ...
            {!isCollapsed && (
              <Pressable
                ...
                style={[
                  styles.item,
                  selectedItem?.type === "forum" && styles.selected,
            ...
            {!isCollapsed && !editable && (
              <Pressable
                ...
                style={[
                  styles.item,
                  selectedItem?.type === "workshops" && styles.selected,
                  isLocked && styles.lockedItem,
                ]}
        ...
        renderItem={({ item: module, index }) => {
          ...
          const isSelected = selectedItem?.module?.id === mid;

          const isEditingModule =
            editingItem?.type === "module" && editingItem.id === mid;

          const isNewModule = editable && !isPublished && module.title === "";
              ...
              {expandedModule === mid && (
                <View>
                  {module.pages?.map((page, i) => {
                    ...
                    const isPageLocked =
                      isLocked || (!editable && status.isLocked);
                      ...
                      >
                        <View style={styles.pageBlock}>
                          ...
                          {editable &&
                            ...
                            !isEditingPage && (
                              <Pressable
                                onPress={() => deletePage(mid, page.id)}
                              >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.confirmCard}>
            ...
            <Text style={styles.confirmSub}>
              Is this page intended to be a{" "}
              <Text style={{ fontWeight: "bold" }}>Final Assessment</Text>?
            </Text>
