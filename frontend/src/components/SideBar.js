...
const SideBar = ({ mobile = false, onNavigate }) => {
  ...
  const displayRoute =
    currentRoute === "AdminStack" || !currentRoute
      ? "Admin Dashboard"
      : currentRoute;
  // Navigation Link
  const menuItems = [
    ...
    <View style={[styles.sidebar, mobile && styles.sidebarMobile]}>
      <View style={styles.link}>
        ...
        {menuItems.map((item) => {
          ...
          const isCourseDetailActive =
            item.name === "Courses" && displayRoute === "Course Details";
      ...
      <View style={styles.admin}>
        <Pressable
          ...
          onPress={() =>
            navigation.navigate("AdminStack", { screen: "User Profile" })
          }
        >
          {/* Profile  */}
          {profileImage ? (
