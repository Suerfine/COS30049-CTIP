...
const NavBar = () => {
  ...
  const displayRoute =
    currentRoute === "ParkGuideStack" || !currentRoute
      ? "Dashboard"
      : currentRoute;
          ...
          <>
            <View style={styles.mobileMenu}>
              {navLinks.map((item) => (
                <Pressable
                  ...
                  style={({ hovered }) => [
                    ...
                    hovered && styles.mobileHoverContainer,
                  ]}
                  onPress={() => {
                    setMobileMenuOpen(false);
              ...
              <Pressable
                style={({ hovered }) => [
                  styles.mobileMenuItem,
                  styles.mobileHoverContainer,
                ]}
                onPress={handleLogout}
              >
                <Text style={[styles.mobileMenuText, { color: "red" }]}>
                  {t("Logout")}
                </Text>
              </Pressable>
            </View>
          ...
          {dropdownVisible && (
            <View ref={dropdownRef} style={styles.dropdown}>
              ...
              <Pressable
                style={({ hovered, pressed }) => [
                  styles.dropdownItem,
                  isActiveRoute("Preferences") && styles.dropdownItemActive,
                  hovered && styles.dropdownItemHover,
                ]}
                onPress={() =>
                  navigation.navigate("ParkGuideStack", {
              ...
              <Pressable
                style={({ hovered, pressed }) => [
                  styles.dropdownItem,
                  isActiveRoute("Security") && styles.dropdownItemActive,
                  hovered && styles.dropdownItemHover,
                ]}
                onPress={() =>
                  navigation.navigate("ParkGuideStack", {
