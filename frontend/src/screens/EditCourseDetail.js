...
const EditCourseDetail = () => {
  ...
  const handleSaveElement = async () => {
    ...
    if (currentElementType === "image") {
      ...
      // Calculate order
      const calculatedOrder = editingElementId
        ? undefined
        : elements.length + 1;
      if (calculatedOrder) {
  ...
  return (
    <View
      style={[styles.rowContainer, isCompact && styles.rowContainerCompact]}
    >
      {/* Outlinebar */}
      {!isCompact && (
        <OutlineBar
            ...
            <View style={styles.mobileOutlineBlock}>
              ...
              >
                <View>
                  ...
                  <Text style={styles.mobileOutlineValue}>
                    {selectedPageLabel}
                  </Text>
                </View>
                {isMobileOutlineOpen ? (
                  ...
                  <View style={{ marginTop: 10 }}>
                    ...
                    <View style={styles.uploadRow}>
                      ...
                      <Text style={styles.uploadStatusText} numberOfLines={1}>
                        {newElementData.imageFile
                          ? newElementData.imageFile.name
                          : "No file chosen"}
                      </Text>
                    </View>
