              ...
              {Array.isArray(filters.location) &&
                filters.location.map((locName) => (
                  ...
                  >
                    ...
                    <Pressable
                      onPress={() => removeFilter("location", locName)}
                    >
                      <CircleX size={16} color="white" />
                    </Pressable>
                  </View>
              ...
              {Array.isArray(filters.category) &&
                filters.category.map((catName) => (
                  <View key={catName} style={styles.pill}>
                    ...
                    <Pressable
                      onPress={() => removeFilter("category", catName)}
                    >
                      <CircleX size={16} color="white" />
                    </Pressable>
                  </View>
              ...
              <View style={styles.cardContainer}>
                {filteredCourses.length === 0 ? (
                  ...
                  filteredCourses.map((course) => {
                    const numModules = course.module_count
                      ? course.module_count
                      : 0;
                    return (
                      <View
                      ...
                      >
                        <CourseCard
                          ...
                          previousEnrollments={getPreviousEnrollments(
                            course.id,
                          )}
                          missingPrerequisites={getUnfulfilledPrerequisites(
                            course,
                          )}
                          onViewHistory={() =>
                          ...
                          onEnroll={() => {
                            ...
                            if (!course.is_enrollable) {
                              ...
                              window.alert(
                                `The following prerequisite(s) has not been fulfilled: ${prereqList}`,
                              );
                              return;
                            }
                            navigation.navigate("ParkGuideStack", {
